...
public class SymbolController {
  ...
  public ResponseEntity<SymbolDTO> create(@RequestBody SymbolDTO dto) {
    ...
    return ResponseEntity.created(URI.create("/api/symbols/" + created.getSymbolId()))
        .body(created);
  }

  @PutMapping("/{id}")
  public ResponseEntity<SymbolDTO> update(
      @PathVariable("id") String id, @RequestBody SymbolDTO dto) {
